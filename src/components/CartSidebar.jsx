...
//         <button 
//           onClick={onClose}
//           className="text-2xl hover:bg-blue-700 w-10 h-10 rounded-full transition-colors"
//         >
//           ✕
//         </button>
//       </div>
...
//             <p className="text-gray-400 text-lg">🛒 Cart khali hai</p>
//           </div>
//         )}
...
//                 <button 
//                   onClick={() => updateQuantity(item.id, 1)}
//                   className="w-8 h-8 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold transition-colors"
//                 >
//                   +
//                 </button>
//               </div>
...
//             className="w-full bg-green-600 text-white font-bold py-4 rounded-lg hover:bg-green-700 transition-colors shadow-lg text-lg"
//           >
//             Checkout Karein 🎉
//           </button>
//         </div>
